...
class PaymentService:
    ...
    PLAN_DESCRIPTIONS = {
        ...
        "day": "Консультация по техпомощи",
        "week": "Консультация по техпомощи",
        "month": "Консультация по техпомощи",
        "3month": "Консультация по техпомощи",
        "year": "Разовый выезд автотехпомощи",
    }
